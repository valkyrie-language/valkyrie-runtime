...
(module $control
    ...
    (type $func (func)) ;; Function<(), ()>      ;; fn() -> ()
    (type $cont (cont $func))                    ;; Continuation<fn() -> ()>
    (type $cont-func (func (param (ref $cont)))) ;; fn(&Continuation<fn() -> ()>) -> ()
    (type $cont-cont (cont $cont-func))          ;; Continuation<fn(Continuation<fn() -> ()>) -> ()>
    (tag $control (param (ref $cont-cont)))      ;; control : &Continuation<fn(Continuation<fn() -> ()>) -> ()>
